...
\clearpage
	...
	Verständnis des Codes.
		...
		Die erste Hälfte, die AK ergibt wird nun benötigt, um die SQN aus der Variable \emph{sqn_ak} zu ermitteln.
		...
		überprüft die if-Abfrage und addiert im Falle eine 1 auf das vorletzte Byte. So oder so wird der Wert von
		\emph{seq} auch wieder in das letzte Byte durch die oder-Operation übertragen.
