...
%TODO: #edit Ubuntu und PPPoE klingen eher wie eine Anleitung, als wie eine "Dokumentation"
	...
	logische Teile unterteilt, nämlich die Variablendeklaration, die Main-Funktion, die die
...
%%TODO: #anhang C-Code hinzufügen #CHECK
...
\subsection{Implementierung der Server-Client Architektur}
\label{server-client-architektur}
    ...
    \subsubsection{Implementierung des Clients}
    ...
    Der Client bleibt so lange in der Authentisierungsschleife, bis diese erfolgreich abgeschlossen werden.
