...
%%TODO: #anhang C-Code hinzufügen
	...
	Codes darunter nicht leidet.
		...
		Anschließend muss	der Serversocket konfiguriert werden. Er wird mit der Funktion bind so eingestellt, dass er
		auf jede IP-Adresse mit Port 12345 hört. Nachdem das konfiguriert ist, wartet das Programm auf eine Verbindungsanfrage
		durch die Funktion listen. Neben der Socket-Beschriebung muss der Funktion listen mitgeteilt werden, wie viele Verbindungen
