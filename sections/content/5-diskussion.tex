...
\label{diskussion}
	...
	\subsection{Ausblick}
		...
		vielleicht auch für SIM-Karten auf dem GSM-Standard ebenfalls die
		...
		der zusäzlcihe Programmieraufwand nicht sehr groß sein wird.
	

		- Code aufräumen
		- Automatisierung der SIM-Kartenerkennung (ein-/ausstecken)	
