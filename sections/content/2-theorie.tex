...
Algorithmus, sowie die Funktionsweise der eingesetzten Blockchiffre \ac{AES} erläutert.
 ...
 werden. Dies zeigt \Abbildung{schematisch_milenage} besser. Dort ist zu erkennen, dass
...
\label{aes}
 ...
 AES auf der anderen Seite hat die Blocklänge auf 128 Bits festegelegt und die Schlüssellänge
 ...
 wie der Verschlüsselungsalgorithmus der beiden funktioniert.
 ...
 DES betrug die Blockgröße nur 64 Bits, was lange Zeit ausreichend war, aber mit Fortschreitung
 der Rechenleistungen nicht mehr lange genügen würde gegen Brute-Force Angriffen (weitere
 Argumente finden sich in \cite{paar10}. Es gab deswegen die Empflung den dreifach DES zu
...
Welte beteiligen konnte und im August 1999 fünf Finalisten gekührt wurden. Dabei wurden
...
verschlüsseln und selbst als \emph{TOP SECRET} einegstufte Dokumente dürfen mit einer
Schlüssellänge von 192 oder 256Bits verschlüsselt werden. \cite{paar10}
 ...
 mehreren Blöcken verschlüsselt wird.
  ...
  ``Counter''. Auf diese soll hier aber nicht näher eingegenagen werden, da diese Elemente der
  ...
  \paragraph{AddRoundKey}
   ...
   Der gesamte Ablauf ist auch grafisch in der Abbildung \ref{abb:funktion_aes} im Anhang dargestellt.
...
Der Informationsfluss findet somit in nachfolgender Hierarchie statt:
 \begin{figure}[htp]
  ...
  \end{center}
  \caption{Roaring Penguin PPPoE Devicehierarchie\cite{roaringpenguinpres}}
