...
%% TODO #edit bei bedarf hier noch die Vorraussetzungen an die Parameter bzw. wie diese modifiziert werden können
 ...
 Beim rotieren wird der Eingabewert um die Anzahl an Bits des Wertes von r rechts rotiert und %TODO: #edit -nach- rechts? 
 ...
 wie schon in Kapitel \Verweis{authentifizierungsvorgang} geschrieben, wird
...
%% AES/Rijndael %%
%% TODO: #edit Kapitel über synchrone/asynchrone Verschlüsselung
...
\label{aes}
 ...
 beide aber 128 Bits lang sein und maximal 256 Bits \cite{daemon02}. \\ %TODO: #edit quelle?
...
Schlüssellänge von 192 oder 256Bits verschlüsselt werden. \cite{paar10}
 ...
 würde. \\
 Eine weiterer Punkt ist der, dass die Menge nicht wie $\Z$ unendlich sein muss, damit eine Gruppenbildung
 möglich ist. Ein Beispiel dafür wird an dieser Stelle jedoch nicht geliefert.
 
 Die Fortsetzung der Gruppe ist der Körper. Diese Struktur unterstützt die vier arithmetischen Basisoperationen
 Addition, Subtraktion, Multiplikation und Division. Die Definition für einen Körper $K$ lautet:
 ...
 Ähnlich wie bei Rijndael spielen im Großteil der Kryptographie die endlichen Körper eine große Rolle.
 Die endliche Menge, die einen Körper zu einem endlichen Körper machen, ist zählbar und die Anzahl
 der Elemente wird ``Ordnung'' oder ``Kardinalität'' genannt. Ein Körper kann jedoch nur
 mir folgendem Theorem endlich sein:
 
 \begin{center}
  \parbox{14.2cm}{\centering
   Ein Körper mit einer Ordnung $m$ existiert nur, wenn $m$ eine Primzahlpotenz ist, wie z.B.:
...
\subsection{Die Sprache C}
 ...
 \paragraph{Pointers}
  ...
  Speicheradresse zugegriffen wird. Wie \Abbildung{c-pointers} dargestellt ist in der Variable c ein
...
\subsubsection{pysim} % TODO #edit bei bedarf noch syntax etc nachtragen
\label{subsec:pysim}
...
aufm ihm betrieben werden können. Beide Typen werden unter \Verweis{subsubsec:hypervisor} genauer
erläutert.
...
Nachfolgende werden diese aufgelistet und beschrieben \cite{victor10}: %TODO: #edit kann das so bleiben?
