...
\label{lst:main.c}
  \lstinputlisting[caption=main.c, language=c]{main.c}

\label{lst:milenage.c}
  \lstinputlisting[caption=milenage.c]{milenage.c}

\label{lst:rijndael.c}
  \lstinputlisting[caption=rijndael.c, language=c]{rijndael.c}

\label{lst:client.py}
  \lstinputlisting[caption=client.py, language=python]{client.py}

\label{lst:pppoe.conf}
  \lstinputlisting[caption=..ppp/pppoe.conf]{pppoe_conf}
 
%\label{lst:allip}
% \lstinputlisting[caption=...ppp/allip]{allip}

\label{lst:pppoe_server_options}
 \lstinputlisting[caption=...ppp/pppoe-server-options]{pppoe-server-options}

\label{lst:pppoe_init}
 \lstinputlisting[caption=...init.d/pppoed, language=bash]{pppoed_init}
